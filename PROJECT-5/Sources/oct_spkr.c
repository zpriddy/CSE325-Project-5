<<<<<<< HEAD:PROJECT-5/Sources/oct_spkr.c
//*******************************************************************************************************
// oct_spkr.c
//
...
void speaker_init()
{
	pwm_channel_init(2,1,3,202,1,100);
...
void speaker_play_note(note_t p_note)
{
	...
	case pitch_c5:
		pwm_channel_set_period(2, 100);
		pwm_set_prescale(2, 3);
		pwm_set_scale(2, 95.6);
		break;
	case pitch_c5_sharp:
		pwm_channel_set_period(2, 100);
		pwm_set_prescale(2, 3);
		pwm_set_scale(2, 90.2);
		break;
	case pitch_d5:
		pwm_channel_set_period(2, 100);
		pwm_set_prescale(2, 3);
		pwm_set_scale(2, 85.1);
		break;
	case pitch_d5_sharp:
		pwm_channel_set_period(2, 100);
		pwm_set_prescale(2, 3);
		pwm_set_scale(2, 80.4);
		break;
	case pitch_e5:
		pwm_channel_set_period(2, 100);
		pwm_set_prescale(2, 3);
		pwm_set_scale(2, 75.8);
		break;
	case pitch_f5:
		pwm_channel_set_period(2, 100);
		pwm_set_prescale(2, 3);
		pwm_set_scale(2, 71.6);
		break;
	case pitch_mute:
		pwm_channel_disable(2);
		break;
...
>>>>>>> f5ea4584b0cbd5b7b04aec5b0994c81c443cefed:PROJECT-5-ZACH/Sources/oct_spkr.c
